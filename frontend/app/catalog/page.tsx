    ...
    <main className="max-w-6xl mx-auto px-6 py-12">
      <div className="flex items-end justify-between gap-6">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">Explore products curated for your next purchase.</p>
        </div>
      </div>
      ...
      {!loading && !error && !products.length ? (
        <div className="mt-10 border border-dashed border-border rounded-2xl p-10 bg-card">
          ...
          <p className="text-muted-foreground mt-1">Create some fake data from the backend or add products in admin.</p>
        </div>
      ) : null}
