...
urlpatterns = [
    ...
    path('versions/<uuid:ver>/certificates/', views.version_certificates, name='version-certificates'),
    path('versions/<uuid:ver>/certificates/<uuid:cert_id>/download/', views.certificate_download, name='certificate-download'),
