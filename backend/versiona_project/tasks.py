"""
Scheduled operational tasks (Celery).

Migrated from the template's Huey periodic tasks; schedules live in
settings.CELERY_BEAT_SCHEDULE and are served by `celery beat`:
